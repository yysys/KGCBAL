...
def trans_dbpedia_to_transHdata(rate):

    in_file = open('./data/dbpedia50/smallScaleTrain' + str(rate) + '.txt', 'r')
    in_file2 = open('./data/dbpedia50/notSimpleData' + str(rate) + '.txt', 'r')
    linkpred_results500_file = open('./data/results/dbpedia50_' + str(rate) + '_500_results.txt', 'r')
    linkpred_results1000_file = open('./data/results/dbpedia50_' + str(rate) + '_1000_results.txt', 'r')
    linkpred_results2000_file = open('./data/results/dbpedia50_' + str(rate) + '_2000_results.txt', 'r')
...
trans_dbpedia_to_transHdata(55)
trans_dbpedia_to_transHdata(60)
trans_dbpedia_to_transHdata(65)
trans_dbpedia_to_transHdata(70)
trans_dbpedia_to_transHdata(75)
trans_dbpedia_to_transHdata(80)
trans_dbpedia_to_transHdata(85)
trans_dbpedia_to_transHdata(90)
trans_dbpedia_to_transHdata(95)
