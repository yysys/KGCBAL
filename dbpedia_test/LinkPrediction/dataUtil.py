...
def simplifyNetwork(in_file_string, sep, out_file_string):
    ...
    simplifiedEntitiesScale = int(dict_E.__len__() * 0.75)
...
survey('./data/dbpedia50/train.txt', '\t')
simplifyNetwork('./data/dbpedia50/train.txt', '\t', './data/dbpedia50/smallScaleTrain.txt')
survey('./data/dbpedia50/smallScaleTrain.txt', '\t')
trans('./data/dbpedia50/train.txt', '\t', './data/dbpedia50.net', 'dbpedia50 network')

def drop(rate):
    in_file = open('./data/dbpedia50/smallScaleTrain.txt', 'r')
    out_file = open('./data/dbpedia50/smallScaleTrain' + str(rate) + '.txt', 'w')
    out_file2 = open('./data/dbpedia50/notSimpleData' + str(rate) + '.txt', 'w')
    triples = []
...
def transToNetworkx(rate):
    trans('./data/dbpedia50/smallScaleTrain' + str(rate) + '.txt',
          '\t', './data/dbpedia50_' + str(rate) + '.net', 'dbpedia50 network')
'''
drop('50')
drop('55')
drop('60')
...
def drop_and_trans_55_to_95():
    ...
    for i in range(9):
        ...
        out_file = open('./data/dbpedia50/smallScaleTrain' + str(55 + i * 5) + '.txt', 'w')
        out_file2 = open('./data/dbpedia50/notSimpleData' + str(55 + i * 5) + '.txt', 'w')
...
def trans_dbpedia50():
    in_file = open('./data/dbpedia50/train_raw.txt', 'r')
    out_file = open('./data/dbpedia50/train.txt', 'w')
